...
public class EmployeeController {
    ...
    // Tüm çalışanları getir (Sadece Admin erişebilir)
    @GetMapping
    // Admin rolüne sahip kullanıcılar erişebilir
    public List<Employees> getAllEmployees() {
        return employeeRepository.findAll();
    }

    // Belirli bir çalışanı getir (Sadece Admin erişebilir)
    @GetMapping("/{id}")
    // Admin rolüne sahip kullanıcılar erişebilir
    ...
    // Yeni bir çalışan ekle (Sadece Admin erişebilir)
    @PostMapping
    // Admin rolüne sahip kullanıcılar erişebilir
    ...
    // Var olan bir çalışanı güncelle (Sadece Admin erişebilir)
    @PutMapping("/{id}")
    ...
    // Bir çalışanı sil (Sadece Admin erişebilir)
    @DeleteMapping("/{id}")
